(function() {
  ...
  var JSONReviewsGeneratorReference = 'https://github.com/PimenovMaxim/VKobsuzhdeniya/blob/master/build/d_reviews.php'; // вписать путь к файлу d_reviews.php (например https://my-site.ru/d_reviews.php)
